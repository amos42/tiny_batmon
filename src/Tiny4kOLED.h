...
#ifndef __TINY4KOLED_H_
#define __TINY4KOLED_H_
...
class SSD1306Device {
	public:
		static  void sendDataStart(void);
		static  void sendDataByte(uint8_t byte);
		static  void sendStop(void);

	public:
		SSD1306Device(uint8_t ssd1306_i2c_address);
